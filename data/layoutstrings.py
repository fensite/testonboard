...
# Copyright © 2011 Francesco Fumanti <francesco.fumanti@gmx.net>
...
# that need translation. As the current build system cannot extract the
...
TRANSLATABLE_LAYOUT_STRINGS = [
    ...
    # translators: this is a 'summary' of the keyboard layout 'Kylin.onboard'
    _("Kylin's desktop keyboard layout"),
]
